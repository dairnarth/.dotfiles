...
statusline.highlight = function()
  vim.cmd.highlight({'Statusline', 'guifg=#f4c3b1', 'guibg=#2d2525', 'gui=none'})
  vim.cmd.highlight({'SL',         'guifg=#f4c3b1', 'guibg=#2d2525', 'gui=none'})
  vim.cmd.highlight({'SLIt',       'guifg=#f4c3b1', 'guibg=#2d2525', 'gui=italic'})
  vim.cmd.highlight({'SLDim',      'guifg=#ab897e', 'guibg=#2d2525', 'gui=none'})
  vim.cmd.highlight({'SLDimIt',    'guifg=#ab897e', 'guibg=#2d2525', 'gui=italic'})
  vim.cmd.highlight({'SLModeN',    'guifg=#f4c3b1', 'guibg=#2d2525', 'gui=none'})
  ...
  vim.cmd.highlight({'SLModeT',    'guifg=#f4c3b1', 'guibg=#2d2525', 'gui=none'})
